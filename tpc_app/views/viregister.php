...
<head>
    ...
    <!-- Bootstrap -->
    <link href="<?php echo base_url();?>/assents/assents/css/bootstrap.min.css" rel="stylesheet">
    <script src="<?php echo base_url();?>/assents/assents/js/bootstrap.min.js"></script>
    <script src="<?php echo base_url();?>/assents/assents/js/jquery-1.11.1.min.js"></script>
</head>
<body>
...
<form class="form-horizontal col-sm-6" role="form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-7">
            <input type="text" name="name" class="form-control" id="name" placeholder="Enter Institute Name">
        </div>
    </div>
        <div class="form-group">
