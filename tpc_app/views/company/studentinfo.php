...
<body>
<div class="col-xs-12" style="border:solid 0px #D3D3D3;padding:5px;margin-top:1%;background:#CCCCCC;border-radius:5px">
					<div class="col-xs-6" style="border:solid 0px #D3D3D3;padding:5px;background:#FFF;color:#0033CC;letter-spacing:1;font-family:Calibri;font-size:20px">Student Profile&nbsp;&nbsp;</div>
					<div class="col-xs-6" style="border:solid 0px #D3D3D3;padding:5px;background:#FFF;color:#0033CC;letter-spacing:1;font-family:Calibri;font-size:20px">
				<a href="#" onClick="history.go(-1);return true;" class="" style="float:right">< -- Back To List -- ></a>
					</div>
